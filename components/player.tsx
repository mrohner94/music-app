...
const Player = ({ songs, activeSong }) => {
  ...
  const onEnd = () => {
    if (repeatRef.current) {
      //when ReactHowler mounts, repeat is false and will always reference that initial value even after the UI is updated, so repeatRef.current can be used here kind of like a global variable
